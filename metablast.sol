...
// File contracts/Token/MetaBlast.sol
...
contract MetaBlast is ERC20, ERC20Burnable, Pausable, TwoPhaseOwnable {
    ...
    constructor() ERC20("MetaBlast", "BLAST") {
    ...
    function batchBlackList(address[] memory _evils, bool[] memory _blacks) external onlyOwner {
        if (_blacks.length == 1) {
            ...
            require(_evils.length == _blacks.length, "BLAST: Input Format Mismatch!");
            for (uint256 i = 0; i < _evils.length; i++) {
        ...
        override
    {
        ...
        require(!blacklisted[from], "BLAST: This sender was blacklisted!");
        require(!blacklisted[to], "BLAST: This recipient was blacklisted!");
